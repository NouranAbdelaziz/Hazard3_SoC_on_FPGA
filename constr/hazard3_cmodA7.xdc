...
## 12 MHz Clock Signal
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { clk_osc }]; #IO_L12P_T1_MRCC_14 Sch=gclk
create_clock -add -name clock -period 83.33 -waveform {0 41.66} [get_ports {clk_osc}];
set_dont_touch_network [get_ports clk_osc]

## LEDs
#set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { gpio }]; #IO_L13P_T2_MRCC_16 Sch=led[2]
...
## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { RSTB }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { fcen  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { uart_rx  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { uart_tx  }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
#set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { tms  }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { fcen  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { fsclk  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { fdio[0]  }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { led  }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { MOSI }]; #IO_L6P_T0_16 Sch=pio[09]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { MISO }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
#set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { fdio[2] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
#set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { fdio[3] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
...
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { tck }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { tms }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { tdi }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { tdo }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
#set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { fdio[2] }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
#set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { fdio[3] }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
...
#set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports { clk_out }]; #IO_L6P_T0_34 Sch=pio[35]
#set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { rst_out }]; #IO_L12P_T1_MRCC_34 Sch=pio[36]
#set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { logic_high }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
...
#set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports { fdoe_out[0] }]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
#set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { fdoe_out[1] }]; #IO_L16P_T2_34 Sch=pio[41]
#set_property -dict { PACKAGE_PIN U2    IOSTANDARD LVCMOS33 } [get_ports { fdoe_out[2] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { fdoe_out[3] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
...
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { clk_out }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { rst_out }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { logic_high }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
...
# Outputs
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {tdo}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {led}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {uart_tx}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {gpio}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {mirror_tck}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {mirror_tms}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {mirror_tdi}];
set_output_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {mirror_tdo}];



# Inputs
set_input_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {tck}];
set_input_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {tms}];
set_input_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {tdi}];
set_input_delay 5.0000 -clock [get_clocks {clock}] -add_delay [get_ports {uart_rx}];
